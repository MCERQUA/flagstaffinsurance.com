      ...
      <div className="container-xl">
        <FadeIn>
          <div className="text-center mb-14">
            ...
            <h2 className="font-heading text-3xl sm:text-4xl text-bark font-bold mb-4">Insurance Built for Flagstaff Businesses</h2>
            <p className="font-body text-muted max-w-2xl mx-auto">
              Every coverage a flagstaff business needs — from day-one GL to completed operations protection years after the job.
            </p>
          </div>
        </FadeIn>
